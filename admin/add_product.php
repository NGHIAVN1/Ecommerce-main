...
if (isset($_POST['submit'])) 
{
    ...
    {
        $result="<h2> Dữ liệu được thêm thành công</h2>";
...
<body>
  ...
  <div class="mb-3">
    <label for="exampleInputType" class="form-label">Phân loại sản phẩm</label>
  ...
  <div class="mb-3">
        <label for="uploadfile" class="form-label">Hình ảnh</label>
